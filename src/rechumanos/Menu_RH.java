 ...
 * @author diego
 */
public class Menu_RH extends javax.swing.JFrame {
    ...
    private void cargar(){
        ...
        setTitle("Menú de Recursos Humanos");
        ...
        //Botón de rutas
        jButtonRuta.setIcon(Imagenes.ajustarImagen("src/Images/Recursos/personal.jpg", jButtonRuta.getWidth(), jButtonRuta.getHeight()));
        jButtonRuta.setBackground(Colores.colorBlancoOsc());
        //Botón de flota
        jButtonFlotilla.setIcon(Imagenes.ajustarImagen("src/Images/Recursos/GestionTiempo.png", jButtonFlotilla.getWidth(), jButtonFlotilla.getHeight()));
        jButtonFlotilla.setBackground(Colores.colorBlancoOsc());
        //Botón de agenda
        jButtonAgenda.setIcon(Imagenes.ajustarImagen("src/Images/Recursos/gestion de viajes.jpg", jButtonAgenda.getWidth(), jButtonAgenda.getHeight()));
    ...
    private void initComponents() {
        ...
        jLabelRutas.setText("Personal");

        jLabelFlota.setText("Gestion del Tiempo");

        jLabelAgenda.setText("Gestion de los viajes");

        jLabelTitulo.setText("Menú Recursos Humanos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_RH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
