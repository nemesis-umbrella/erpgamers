 ...
 */
public class FormGestiondelTiempo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "fecha_creacion", "Nombre", "Proposito", "Validador", "Fecha de creación", "Fecha mod."
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormGestiondelTiempo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormGestiondelTiempo().setVisible(true);
            }
        });
    }
